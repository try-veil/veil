...
export default function Subscribe() {
  return (
    <div className="flex px-6 bg-background flex-col items-center justify-center gap-0 lg:gap-4 pb-24 min-h-[70vh]">
      <h2 className="text-xl px-2 lg:text-4xl font-black text-center">
